...
public class WMG_Node : WMG_GUI_Functions {
	...
	public GameObject CreateLink (GameObject target, Object prefabLink, int linkId, GameObject parent) {
...
//		objLink.transform.parent = target.transform.parent;
		...
		theTarget.numLinks++;
		numLinks++;
		theLink.Setup(this.gameObject, target, linkId); // automatically repositions and scales the link based on the nodes
		return objLink;
	}
